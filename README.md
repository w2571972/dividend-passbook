...
需要先安裝 [Node.js](https://nodejs.org/)（22 版以上）與 Python 3。
...
資料來源：臺灣證券交易所，依[政府資料開放授權條款－第 1 版](https://data.gov.tw/license)利用，經 FinMind 與證交所 OpenAPI 取得。殖利率、填息天數等為本站依原始資料計算的結果。本工具僅供整理與學習，不構成投資建議。資料可能延遲或有誤，交易前請以證交所及發行公司公告為準。
